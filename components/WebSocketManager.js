...
//   useEffect(() => {
//     if (!onMessageCallback || typeof onMessageCallback !== 'function') {
//       console.log('onMessageCallback is not a valid function:', onMessageCallback);
//       return;
//     }
...
//     subscribers.push(onMessageCallback);
  
//     return () => {
//       subscribers = subscribers.filter(sub => sub !== onMessageCallback);
//     };
//   }, [onMessageCallback]);

//   const initializeWebSocket = () => {
//     webSocketInstance = new WebSocket('wss://stream.data.alpaca.markets/v2/iex');
...
// export const subscribeToStockUpdates = (symbols) => {
//   if (!webSocketInstance) {
//     console.log('WebSocket instance is null. Cannot subscribe yet.');
//     return;
//   }
...
// export const unsubscribeFromStockUpdates = (symbols) => {
//   if (!symbols || typeof symbols !== 'string') {
//     //console.error('Invalid symbols provided. Expected a non-empty string.');
//     return;
//   }
...
//     }));
//   } else {
//     console.error('WebSocket is not open. Cannot unsubscribe.');
//   }
// };
